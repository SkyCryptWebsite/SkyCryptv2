...
async function main() {
  const bestiary = await fetch("https://raw.githubusercontent.com/NotEnoughUpdates/NotEnoughUpdates-REPO/prerelease/constants/bestiary.json").then((res) => res.json());
