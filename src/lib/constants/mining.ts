...
class MiningSpeed2 extends Node {
  ...
  perk(level: number) {
    const val = level * 40;
    return [`§7Grants §a+${val} §6${constants.SYMBOLS.mining_speed} Mining Speed§7.`];
  }
}
...
class MiningFortune2 extends Node {
  ...
  perk(level: number) {
    const val = level * 5;
    return [`§7Grants §a+${val} §6${constants.SYMBOLS.mining_fortune} Mining Fortune§7.`];
  }
}
...
class LonesomeMiner extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Increases §c${constants.SYMBOLS.strength} Strength, §9${constants.SYMBOLS.crit_chance} Crit Chance, §9${constants.SYMBOLS.crit_damage} Crit Damage, §a${constants.SYMBOLS.defense} Defense, and §c${constants.SYMBOLS.health} Health §7statistics gain by §a${val}% §7while in the Crystal Hollows.`];
  }
}
...
class Professional extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Gain §a+${val}§7 §6${constants.SYMBOLS.mining_speed} Mining Speed§7 when mining Gemstones.`];
  }
}
...
class Fortunate extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Grants §a+${val}§7 §6${constants.SYMBOLS.mining_fortune} Mining Fortune§7 when mining Gemstone.`];
  }
}
...
class ManiacMiner extends Node {
  ...
  perk(level: number) {
    ...
    return ["§6Pickaxe Ability: Maniac Miner", `§7Spends all your Mana and grants §a+${speed} §6${constants.SYMBOLS.mining_speed} Mining Speed §7for every 10 Mana spent, for §a${duration}s§7.`, `§8Cooldown: §a${cooldown}s`, "", "§8Pickaxe Abilities apply to all of your pickaxes. You can select a Pickaxe Ability from your Heart of the Mountain.", "", "§8Upgrade your Pickaxe Abilities by unlocking §cPeak of the Mountain §8in this menu!"];
  }
}
...
class SkyMall extends Node {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  perk(level: number) {
    return ["§7Every SkyBlock day, you receive a random buff in the §2Dwarven Mines§7.", "", "§7Possible Buffs", `§8 ■ §7Gain §a+100 §6${constants.SYMBOLS.mining_speed} Mining Speed§7.`, `§8 ■ §7Gain §a+50 §6${constants.SYMBOLS.mining_fortune} Mining Fortune§7.`, "§8 ■ §7Gain §a+15% §7chance to gain extra Powder while mining.", "§8 ■ §7Reduce Pickaxe Ability cooldown by §a20%§7.", "§8 ■ §7§a10x §7chance to find Goblins while mining.", "§8 ■ §7Gain §a5x §9Titanium §7drops."];
  }
}
...
class MiningMadness extends Node {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  perk(level: number) {
    return [`§7Grants §a+50 §6${constants.SYMBOLS.mining_speed} Mining Speed §7and §6${constants.SYMBOLS.mining_fortune} Mining Fortune§7.`];
  }
}
...
class FrontLoaded extends Node {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  perk(level: number) {
    return [`§7Grants §a+100 §6${constants.SYMBOLS.mining_speed} Mining Speed §7and §6${constants.SYMBOLS.mining_fortune} Mining Fortune §7as well as §a+2 base powder §7for the first §e2,500 §7ores you mine in a day.`];
  }
}
...
class PrecisionMining extends Node {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  perk(level: number) {
    return [`§7When mining ore, a particle target appears on the block that increases your §6${constants.SYMBOLS.mining_speed} Mining Speed §7by §a30% §7when aiming at it.`];
  }
}
...
class Crystallized extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Increases §6${speed} ${constants.SYMBOLS.mining_speed} Mining Speed §7and §6${fortune} ${constants.SYMBOLS.mining_fortune} Mining Fortune §7near §5Fallen Stars§7.`];
  }
}
...
class MiningSpeedBoost extends Node {
  ...
  perk(level: number) {
    ...
    return ["§6Pickaxe Ability: Mining Speed Boost", `§7Grants §a+${effect}% §6${constants.SYMBOLS.mining_speed} Mining Speed §7for §a${duration}s§7.`, `§8Cooldown: §a${cooldown}s`, "", "§8Pickaxe Abilities apply to all of your pickaxes. You can select a Pickaxe Ability from your Heart of the Mountain.", "", "§8Upgrade your Pickaxe Abilities by unlocking §cPeak of the Mountain §8in this menu!"];
  }
}
...
class RagsOfRiches extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Grants §a+${val} §6${constants.SYMBOLS.mining_fortune} Mining Fortune §7while mining inside a §bGlaite Mineshaft`];
  }
}
...
class HazardousMiner extends Node {
  ...
  perk() {
    ...
    const cooldown = [140, 140, 140][this.pickaxeAbilityLevel - 1];
    return ["§6Pickaxe Ability: Hazardous Miner", `§7Grants §a+${boost} §6${constants.SYMBOLS.mining_speed} Mining Speed §7for §a${duration}s §7for each enemy within §a${radius} §7blocks`, `§8Cooldown: §a${cooldown}s`, "", "§8Pickaxe Abilities apply to all of your pickaxes. You can select a Pickaxe Ability from your Heart of the Mountain.", "", "§8Upgrade your Pickaxe Abilities by unlocking §cPeak of the Mountain §8in this menu!"];
  }
}
...
class SubzeroMining extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Grants §a+${val} §6${constants.SYMBOLS.mining_fortune} Mining Fortune §7when mining §bGlacite§7.`];
  }
}
...
class EagerAdventurer extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Grants §a+${val} §6${constants.SYMBOLS.mining_speed} Mining Speed §7when inside the §bGlacite Mineshafts§7.`];
  }
}
...
class WarmHearted extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Grants §a+${val} §b${constants.SYMBOLS.cold_resistence} Cold Resistence§7.`];
  }
}
...
class StrongArm extends Node {
  ...
  perk(level: number) {
    ...
    return [`§7Gain §a+${val} §6${constants.SYMBOLS.mining_speed} Mining Speed §7when mining Tungsten or Umber.`];
  }
}
...
class MineshaftMayhem extends Node {
  ...
  perk() {
    return [`§7Every time your enter a §bGlacite Mineshaft§7, you receive a random buff.`, ``, `§7Possible Buffs`, `§8 ■ §a+5% §7chance to find a §9Suspicious Scrap§7.`, `§8 ■ §7Gain §a100 §6${constants.SYMBOLS.mining_speed} Mining Speed§7.`, `§8 ■ §7Gain §a200 §6${constants.SYMBOLS.mining_fortune} Mining Fortune§7.`, `§8 ■ §7Gain §a+10 §b${constants.SYMBOLS.cold_resistence} Cold Resistence§7.`, `§8 ■ §7Reduce Pickaxe Ability cooldown by §a25%§7.`];
  }
}
