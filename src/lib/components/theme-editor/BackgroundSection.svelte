...
<div class="flex flex-col gap-8 p-4">
  <div class="flex flex-col gap-4">
    <h3 class="text-sm font-bold tracking-wider text-muted-foreground uppercase">Page Background</h3>
  ...
  <div class="flex flex-col gap-4">
    <h3 class="text-sm font-bold tracking-wider text-muted-foreground uppercase">Enchanted Glint</h3>
