...
<div
  ...
  <div class="flex flex-col gap-1">
    ...
    <div class="h-3 w-44 animate-pulse rounded-xl bg-foreground/10"></div>
  </div>
  <div class="absolute right-3 bottom-3 size-5 animate-pulse rounded-xl bg-foreground/10"></div>
</div>
