...
<ScrollArea
  ...
  {...restProps}>
  <div
    class="relative flex gap-4 py-4 group-data-[orientation=horizontal]/scroll:w-max group-data-[orientation=horizontal]/scroll:flex-nowrap group-data-[orientation=vertical]/scroll:flex-wrap">
    {@render children?.()}
    <div
